        ...
        <main className="container mx-auto px-4 py-12">
          <Card className="max-w-md mx-auto">
            <CardHeader className="text-center">
              ...
              <CardDescription>
                Sign in or create an account to start your driver application
              </CardDescription>
            </CardHeader>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground mt-2">
              {hasApplied 
                ...
                : 'Complete the form below to apply as a Koloi driver'
              }
            </p>
          </div>
          ...
          <div className="space-y-6">
            {hasApplied && driverProfile ? (
              ...
              <DriverApplicationForm onSuccess={refetchDriver} />
            )}
          </div>
        </div>
      </main>
