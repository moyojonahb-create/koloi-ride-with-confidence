...
const LocationInput = ({
  ...
  return (
    <div className="space-y-2" ref={wrapperRef}>
      ...
      {/* Text Input with UP-popping dropdown (inDrive style) */}
      <div className="relative">
        {/* Suggestions dropdown — floats ABOVE the input */}
        {isFocused && (
          <div
            ref={dropdownRef}
            className="absolute bottom-full left-0 right-0 mb-2 z-50 bg-card rounded-xl shadow-xl border border-border overflow-hidden max-h-[320px] overflow-y-auto"
          >
            {/* My Location option for dropoff */}
